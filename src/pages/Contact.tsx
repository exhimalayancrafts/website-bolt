    ...
    <div className="bg-stone-50">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-7">
              {submitted ? (
                <div className="bg-stone-100 border border-stone-300 p-12 rounded-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <label className="block font-sans text-[10px] tracking-widest uppercase text-stone-500 mb-3">
                        Name
                      </label>
                      <input
                        type="text"
                        ...
                        required
                        className="w-full bg-transparent border-b border-stone-300 py-3 font-sans text-sm text-stone-900 focus:outline-none focus:border-stone-900 transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block font-sans text-[10px] tracking-widest uppercase text-stone-500 mb-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-transparent border-b border-stone-300 py-3 font-sans text-sm text-stone-900 focus:outline-none focus:border-stone-900 transition-colors cursor-pointer"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full bg-transparent border-b border-stone-300 py-3 font-sans text-sm text-stone-900 focus:outline-none focus:border-stone-900 transition-colors resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="font-sans text-xs tracking-wide text-stone-600 hover:text-stone-900 border-b border-stone-400 hover:border-stone-900 pb-1 transition-colors"
                  >
                    Send Message
                  </button>
                </form>
      ...
      <section className="py-20 px-6 lg:px-12 bg-stone-100">
        <div className="max-w-6xl mx-auto">
          <MediaPlaceholder
            type="image"
            label="Office location or facility — Kathmandu context"
            aspect="aspect-video"
