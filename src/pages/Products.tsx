    ...
    <div className="bg-stone-50">
      ...
      <section className="py-12 px-6 lg:px-12 border-b border-stone-200">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="font-sans text-base text-stone-600 max-w-2xl leading-relaxed">
            <SiteText page="products" slot="page-intro" defaultContent="Finished textiles crafted from Himalayan fibers — presented here as objects of material and craft." />
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-2xl">
            <h2 className="font-serif text-xl md:text-2xl font-light text-stone-900 mb-3">
              <SiteText page="products" slot="featured-heading" defaultContent="Cashmere Shawls" />
            </h2>
            <p className="font-sans text-base text-stone-600 leading-relaxed">
              <SiteText page="products" slot="featured-body" defaultContent="Fine cashmere shawls woven from high-altitude fiber. Each piece carries the softness and warmth of its origin, finished with hand-twisted fringes and careful quality control." />
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-12 bg-stone-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-stone-300">
            {collections.map((c) => (
      ...
      <section className="py-16 px-6 lg:px-12 bg-stone-100">
        <div className="max-w-2xl mx-auto text-center">
          <p className="font-sans text-base text-stone-600 leading-relaxed">
            <SiteText page="products" slot="inquiry-note" defaultContent="Products are available through wholesale partnership and custom order. For specifications, samples, and wholesale terms, please get in touch." />
          </p>
          <Link to="/contact" className="inline-block font-sans text-sm text-stone-700 hover:text-stone-900 mt-6 transition-colors">
            Make an inquiry →
          </Link>
        </div>
      </section>
