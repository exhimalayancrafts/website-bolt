    ...
    <div className="bg-stone-50">
      ...
      <section className="py-16 px-6 lg:px-12 border-b border-stone-200">
        <div className="max-w-6xl mx-auto">
          <p className="font-sans text-[10px] tracking-widest uppercase text-stone-500 mb-4">About</p>
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-light text-stone-900 mb-5 leading-tight">
            The Company
          </h1>
          <p className="font-sans text-base text-stone-600 max-w-2xl leading-relaxed">
            We source, process, and manufacture Himalayan natural fibers for international brands. Family-run and based in Kathmandu since 1998.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7">
              <SiteImage
                ...
                fallbackLabel="Founder portrait"
                aspect="aspect-[4/5]"
                className="rounded-sm mb-10 w-full max-w-sm"
              />
              <div className="space-y-5">
                ...
                <a
                  ...
                  className="inline-block font-sans text-sm text-stone-900 underline underline-offset-4 hover:text-stone-600 transition-colors"
                >
      ...
      <section className="py-20 px-6 lg:px-12 bg-stone-100">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4">
              <p className="font-sans text-[10px] tracking-widest uppercase text-stone-500 mb-4">Philosophy</p>
            </div>
            <div className="lg:col-span-7">
              <h2 className="font-serif text-2xl md:text-3xl font-light text-stone-900 mb-10 leading-snug">
                How we work
              </h2>
              <div className="space-y-10">
                <div className="border-l border-stone-400 pl-8">
                  <h3 className="font-serif text-lg font-medium text-stone-900 mb-3">Direct Relationships</h3>
                  <p className="font-sans text-base text-stone-600 leading-relaxed">
                    We buy directly from herders we work with personally. We know the people, the animals, and the regions. There are no middlemen between us and the source.
                  </p>
                </div>
                <div className="border-l border-stone-400 pl-8">
                  <h3 className="font-serif text-lg font-medium text-stone-900 mb-3">Owned Production</h3>
                  <p className="font-sans text-base text-stone-600 leading-relaxed">
      ...
      <section className="py-20 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <p className="font-sans text-[10px] tracking-widest uppercase text-stone-500 mb-4">History</p>
            <h2 className="font-serif text-2xl md:text-3xl font-light text-stone-900">Company evolution</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-stone-300">
            {milestones.map((milestone) => (
              <div key={milestone.year} className="bg-stone-50 p-8 min-h-[180px]">
                <p className="font-sans text-xs text-stone-400 mb-3">{milestone.year}</p>
                <h3 className="font-serif text-lg font-medium text-stone-900 mb-3">{milestone.title}</h3>
                <p className="font-sans text-sm text-stone-600 leading-relaxed">{milestone.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-stone-900 text-stone-100">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4">
              <p className="font-sans text-[10px] tracking-widest uppercase text-stone-400 mb-4">Associations</p>
            </div>
            <div className="lg:col-span-7">
              <h2 className="font-serif text-2xl md:text-3xl font-light text-stone-100 mb-10 leading-snug">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pt-6 border-t border-stone-700">
                  ...
                  <ul className="space-y-2">
                    <li className="font-sans text-base text-stone-300">Nepal Pashmina Industries Association (NPIA)</li>
                    <li className="font-sans text-base text-stone-300">Nepal Fibre Processing Private Limited (NFPPL)</li>
                    <li className="font-sans text-base text-stone-300">Federation of Handicrafts Associations of Nepal (FHAN)</li>
                    <li className="font-sans text-base text-stone-300">Federation of Nepalese Chambers of Commerce & Industries (FNCCI)</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <SiteImage
              page="about"
              slot="office"
              fallbackLabel="Kathmandu office or facility"
              aspect="aspect-[4/3]"
              className="rounded-sm w-full"
            />
            <div className="flex flex-col justify-center">
              <p className="font-sans text-[10px] tracking-widest uppercase text-stone-500 mb-4">Location</p>
